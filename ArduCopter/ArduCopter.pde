...
// #if AIRSPEED == ENABLED
/*#if CONFIG_HAL_BOARD == HAL_BOARD_APM1 || CONFIG_HAL_BOARD == HAL_BOARD_APM2
 #error Unrecognized AIRSPEED setting
#elif CONFIG_HAL_BOARD == HAL_BOARD_PX4*/

// Dummy Var to allow Airspeed to construct
static AP_Vehicle::FixedWing fixed_wing;

AP_Airspeed airspeed(fixed_wing); // from "backend driver for airspeed from a I2C MS4525D0 sensor"
//#endif
// #endif
